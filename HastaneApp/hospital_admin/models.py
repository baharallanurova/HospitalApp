...
class Clinical_Laboratory_Technician(models.Model):
    ...
    phone_number = models.IntegerField(null=True, blank=True)
    featured_image = models.ImageField(upload_to='technician/', default='technician/user-default.png', null=True,
                                       blank=True)
    hospital = models.ForeignKey(Hospital_Information, on_delete=models.SET_NULL, null=True, blank=True)
...
class hospital_department(models.Model):
    ...
    featured_image = models.ImageField(upload_to='departments/', default='departments/default.png', null=True,
                                       blank=True)
